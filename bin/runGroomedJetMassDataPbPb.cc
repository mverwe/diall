#include "UserCode/diall/analyzeGroomedJetMassDataPbPb.C"
...
int main(int argc, char* argv[])
{
  ...
  std::string outname = "AnaResultsGroomedJetMass.root";
  int maxEvts = runProcess.getParameter<int>("maxEvents");
    
  analyzeGroomedJetMass(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,doJetShift,doZgReweight);
