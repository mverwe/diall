#include "UserCode/diall/analyzeZgHistosCrossChecksDataPbPb.C"
...
int main(int argc, char* argv[])
{
  ...
  std::string outname = "AnaResultsZgCrossChecks.root";
  int maxEvts = runProcess.getParameter<int>("maxEvents");
    
  analyzeZgHistosCrossChecks(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,doJetShift);
