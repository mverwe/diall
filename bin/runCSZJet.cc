#include "UserCode/diall/analyzeCSZJet.C"
...
//    std::cout << *i << std::endl;
  ...
  std::string outname = "AnaResultsCSZJet.root";
  ...
  analyzeCSZJet(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,ptminType,jetSignalType);
