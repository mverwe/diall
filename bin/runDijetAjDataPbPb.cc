#include "UserCode/diall/analyzeDijetAjDataPbPb.C"
...
int main(int argc, char* argv[])
{
  ...
  std::string outname = "AnaResultsDijetAj.root";
  int maxEvts = runProcess.getParameter<int>("maxEvents");
    
  analyzeDijetAj(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent);
