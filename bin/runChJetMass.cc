#include "UserCode/diall/analyzeGenChJetMass.C"
...
int main(int argc, char* argv[])
{
  ...
  std::string outname = "AnaResultsJetMass.root";
  int maxEvts = runProcess.getParameter<int>("maxEvents");
    
  analyzeGenChJetMass(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent);
