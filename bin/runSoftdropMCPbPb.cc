#include "UserCode/diall/analyzeSoftdropMCPbPb.C"
...
int main(int argc, char* argv[])
{
  ...
  std::string outname = "AnaResultsSD.root";
  int maxEvts = runProcess.getParameter<int>("maxEvents");
    
  analyzeSoftdrop(urls,outname.c_str(),maxEvts,firstFile,lastFile,firstEvent,doJetShift,doZgReweight);
