...
void analyzeZgHistosCrossChecks(std::vector<std::string> urls, const char *outname = "eventObjects.root", Long64_t nentries = 20, Int_t firstF = -1, Int_t lastF = -1, Int_t firstEvent = 0, int activateJetShift = 0) {
  ...
  Printf("anaZgHistosCrossChecks create");
  anaZgHistosCrossChecks *anazghistos = new anaZgHistosCrossChecks("anaZgHistos","anaZgHistos");
  Printf("anaZgHistosCrossChecks created");
  ...
  anaZgHistosCrossChecks *anazghistosdrSmall = new anaZgHistosCrossChecks("anaZgHistosDrSmall","anaZgHistosDrSmall");
  ...
  anaZgHistosCrossChecks *anazghistosdrLarge = new anaZgHistosCrossChecks("anaZgHistosDrLarge","anaZgHistosDrLarge");
  ...
  if(doDRVar) {
    anaZgHistosCrossChecks *anazghistosDRVarDown = new anaZgHistosCrossChecks("anaZgHistosDrVarDown","anaZgHistosDrVarDown");
    ...
    anaZgHistosCrossChecks *anazghistosDRVarUp = new anaZgHistosCrossChecks("anaZgHistosDrVarUp","anaZgHistosDrVarUp");
